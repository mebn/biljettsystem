-- Events
INSERT INTO Event (EventID, Name, Description, Price, StartTime, Location, NumTick, EventPictureLink)
...
INSERT INTO Category (CategoryID, Name) VALUES (5, Festival);
...
INSERT INTO User (UserID, Name, Mail) VALUES (1, 'Lisa A', 'lisa01@gmail.se');

INSERT INTO User (UserID, Name, Mail) VALUES (2, 'Lisa B', 'lisa02@gmail.se');

INSERT INTO User (UserID, Name, Mail) VALUES (3, 'Lisa C', 'lisa03@gmail.se');

INSERT INTO User (UserID, Name, Mail) VALUES (4, 'Lisa D', 'lisa04@gmail.se');

INSERT INTO User (UserID, Name, Mail) VALUES (5, 'Lisa E', 'lisa05@gmail.se');
...
INSERT INTO Ticket (TicketID, PurchaseID) 
VALUES (1, 1);
INSERT INTO Ticket (TicketID, PurchaseID) 
VALUES (2, 1);
INSERT INTO Ticket (TicketID, PurchaseID) 
