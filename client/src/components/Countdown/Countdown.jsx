...
const Countdown = (props) => {
    ...
    const startCountdown = () => {
        const countdownDate = new Date(props.releaseDate).getTime() // Get the target time in ms
        ...
        {props.released || (
            <div className=" text-1 text-center py-4 border-b-2">
                ...
                <div className="mt-3 font-bold text-[14px]">
                    Släppdatum:<span className="font-normal ml-1.5">{props.releaseDate}</span>
                </div>
            </div>
        )
    }
